...
//  Quat<float> qsum;
//  Quat_Add(q1,q2,qsum);
//  cout<<"Quat_Add"<<" "<<qsum.W()<<" "<<qsum.X()<<" "<<qsum.Y()<<" "<<qsum.Z()<<endl;
//  Quat<float> qsub;
//  Quat_Sub(q1,q2,qsub);
//  cout<<"Quat_Sub"<<" "<<qsub.W()<<" "<<qsub.X()<<" "<<qsub.Y()<<" "<<qsub.Z()<<endl;
//  Quat<float> qconj;
//  Quat_Conjugate(q1,qconj);
//  cout<<"Quat_Conjugate"<<" "<<qconj.W()<<" "<<qconj.X()<<" "<<qconj.Y()<<" "<<qconj.Z()<<endl;
//  Quat_Scale(q1,(float)3);
//  cout<<"Quat_Scale"<<" "<<q1.W()<<" "<<q1.X()<<" "<<q1.Y()<<" "<<q1.Z()<<endl;
//  float temp=Quat_Norm(q1);
//  cout<<"Quat_Normal"<<" "<<q1.W()<<" "<<q1.X()<<" "<<q1.Y()<<" "<<q1.Z()<<endl;
//  float temp1=Quat_Norm2(q2);
//  cout<<"Quat_Norma2"<<" "<<q2.W()<<" "<<q2.X()<<" "<<q2.Y()<<" "<<q2.Z()<<endl;
//  Quat<float> qn;
//  Quat_Normalize(q1,qn);
//  cout<<"Quat_Normalize"<<" "<<qn.W()<<" "<<qn.X()<<" "<<qn.Y()<<" "<<qn.Z()<<endl;
//  Quat<float> qi;
//  Quat_Unit_Inverse(qn,qi);
//  cout<<"Quat_Unit_Inverse"<<" "<<qi.W()<<" "<<qi.X()<<" "<<qi.Y()<<" "<<qi.Z()<<endl;
//  Quat<float> qi1;
//  Quat_Inverse(q1,qi1);
//  cout<<"Quat_Inverse"<<" "<<qi1.W()<<" "<<qi1.X()<<" "<<qi1.Y()<<" "<<qi1.Z()<<endl;
//  Quat<float> qprod;
//  Quat_Mul(q1,q2,qprod);
//  cout<<"Quat_Mul"<<" "<<qprod.W()<<" "<<qprod.X()<<" "<<qprod.Y()<<" "<<qprod.Z()<<endl;
//  Quat<float> q3(1,2,0,1);
//  Quat<float> qprod1;
//  Quat_Triple_Product(q1,q2,q3,qprod1);
//  cout<<"Quat_Triple_Product"<<" "<<qprod1.W()<<" "<<qprod1.X()<<" "<<qprod1.Y()<<" "<<qprod1.Z()<<endl;
//  float m_v[3]={1,0,1};
//  Vector3<float> v(m_v);
//  Vector3_Theta_Quat(q1,v,(float)45);
//  cout<<"Vector3_Theta_Quat"<<" "<<q1.W()<<" "<<q1.X()<<" "<<q1.Y()<<" "<<q1.Z()<<endl;
//  float m_v1[4]={1,0,2,5};
//  Vector4<float> v1(m_v1);
//  Vector4_Theta_Quat(q2,v1,(float)60);
//  cout<<"Vector4_Theta_Quat"<<" "<<q2.W()<<" "<<q2.X()<<" "<<q2.Y()<<" "<<q2.Z()<<endl;


float m[3]={1,2,3};
Vector3<float> cube_model[3]={Vector3<float> (m),Vector3<float> (m),Vector3<float> (m)};
cout<<cube_model[0].X()<<" "<<cube_model[2].Y()<<endl;
Point3<float> n1(11,12,13);
Point3<float> n2(21,22,23);
Point3<float> n3(31,32,33); 
Point3<float> n4(41,42,43);
Point3<float> n5(51,52,53);
Point3<float> n6(61,62,63);
Point3<float> n7(71,72,73);
Point3<float> n8(81,82,83);
Point3<float> cube[8]={n1,n2,n3,n4,n5,n6,n7,n8};
int temp=0;
for(int i=0;i<8;i++)
{
	cout<<cube[i].X()<<" "<<cube[i].Y()<<" "<<cube[i].Z()<<endl;
	temp++;
}
cout<<temp<<endl;
